...
export const JoinChannelUsers = (props: Props) => {
  ...
  const fetchUsers = async () => {
    const resJson = await (await fetch("/api/channelMembers"))
      .json()
      .catch((err) => {});
  ...
  return (
    <div className={classNames(className || "")}>
      <div className={classNames("flex items-center text-[18px]")}>
        <div className="w-[300px] text-text2">New Join Channel Users</div>
